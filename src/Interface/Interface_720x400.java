...
public class Interface_720x400 extends javax.swing.JFrame {

    public Interface_720x400() {
        initComponents();
    ...
    private void initComponents() {
        ...
        superiorBar.add(exitButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 0, 60, 30));
        ...
        superiorBar.add(minimizeButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 0, 60, 30));

        Background.add(superiorBar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 430, 30));

        getContentPane().add(Background, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 400, 720));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Interface_720x400.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Interface_720x400().setVisible(true);
            }
        });
    }
